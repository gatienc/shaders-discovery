...
void main() {
  ...
  // part 5 - add layers (a.k.a octaves) of value noise
    ...
    vn += valueNoiseFn(uv * 128.0) * 0.03125;
    vn += valueNoiseFn(uv * 256.0) * 0.015625;
    vn += valueNoiseFn(uv * 512.0) * 0.0078125;
    vn += valueNoiseFn(uv * 1024.0) * 0.00390625;
    vn += valueNoiseFn(uv * 2048.0) * 0.001953125;
    vn /= 2.0;
    color = vec3(vn);
